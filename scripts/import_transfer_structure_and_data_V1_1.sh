...
# Example command:
# URL_DATA_ZIP="http://data.geo.admin.ch/ch.bazl.sicherheitszonenplan.oereb/data.zip" SCHEMA_NAME="airports_safety_zone_plans" bash scripts/import_transfer_structure_and_data_V1_1.sh
...
# models
model_repository='https://models.geo.admin.ch/V_D/OeREB/replaced/'
model_OeREBKRMtrsfr="OeREBKRMtrsfr_V1_1"

# law_xml_file
law_xml_file="OeREBKRM_V1_1_Gesetze_20180501.xml"
